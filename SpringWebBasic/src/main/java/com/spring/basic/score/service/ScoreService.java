...
public class ScoreService {
	...
	/*
	 ...
	 그런데 repository는 학생 정보가 모두 포함된 리스트를 주네?
	...
	public List<ScoreListResponseDTO> getList() {
		...
		for (Score score : scoreRepository.findAll()) {
			// 변환한 DTO를 DTO list에 추가
			dtoList.add(new ScoreListResponseDTO(score));
		}
	...
	public void modify(int stuNum, ScoreRequestDTO dto) {
		...
		scoreRepository.updateByStuNum(stuNum, score);
	}
}
