...
public class BoardController {
	...
	public String write(String writer, String title, String content) {
		...
		System.out.println(String.format("writer: %s, title: %s, content: %s", writer, title, content));
	...
	// 글 내용 상세보기 요청 처리 메서드
	@GetMapping("/content")
	public void content(Model model, int boardNo) {
		System.out.println("/board/content?boardNo=" + boardNo +": GET");
		retrieve(model, boardNo);	
	}
	...
	@GetMapping("/modify")
	public void modify(Model model, int boardNo) {
	...
	public void retrieve(Model model, int boardNo) {
