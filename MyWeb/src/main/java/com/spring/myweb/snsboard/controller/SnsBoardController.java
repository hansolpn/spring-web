...
public class SnsBoardController {
	...
	@PostMapping()
	public String upload(SnsBoardRequest dto) {
		service.insert(dto);
	...
	public ResponseEntity<?> getImage(@PathVariable String fileLoca, @PathVariable String fileName) {
		...
		HttpHeaders headers = new HttpHeaders(); // 응답 해더 객체 생성
		...
		try {
			...
			// ResponeRntity 객체에 전달하고자 하는 파일을 byte[]로 변환해서 전달 (파일의 손상을 막기 위해)
	...
	public List<Integer> like(@PathVariable String userId) {
