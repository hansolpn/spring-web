...
public class MailSenderService {
	...
	public String joinEmail(String email) {
		...
		String setFrom = "pinecone171@gmail.com"; // email-config에 설정한 발신용 이메일 주소 입력
		String toMail = email; // 수신받을 이메일(가입하고자 하는 사람의 이메일)
		String title = "myweb 회원가입 인증 이메일 입니다."; // 이메일 제목
		String content = "홈페이지 가입을 신청해 주서서 감사합니다." +
				"<br><br>" +
