                    ...
                    <form action="/myweb/user/join" method="post" name="joinForm">
                        <div class="form-group"><!--사용자클래스선언-->
                            ...
                            <div class="input-group"><!--input2탭의 input-addon을 가져온다 -->
                                <input type="text" id="userId" name="userId" class="form-control" id="userId" placeholder="아이디를 (영문포함 8~12자 이상)">
    ...
    <script>
            ...
            */
            ...
            // Promise 객체의 상태가 요청 성공일 시 데이터 후속 처리 진행
                .then(res => {
                    ...
                    // 함수의 매개변수를 선언하면 해당 매개변수로 응갑에 관련된
                ...
                .catch(err => { // 통신 과정에서 에러가 발생했을 경우에만 실행되는 함수
        ...
        document.querySelector('.mail-check-input').onblur = (e) => {
            ...
            if (inputCode == code) {
                ...
                // 사용자가 select의 옵션을 처음 선택했을 때의 값을 기역했다가
        ...
        // 다음 주소 api 사용해 보기 (stript src 추가 해야합니다.)
