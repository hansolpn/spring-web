...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <div id="replyList">
                            <!-- 자바스크립트를 활용하여 반복문을 이용해서 댓글의 갯수만큼 반복 표현
    ...
    <script>
        window.onload = () => {
            ...
            // reset -> true: 페이지를 리셋해서 새롭게 그러내기, reset -> false: 누적해서 쌓기
            function getList(pageNum, reset) {
                ...
                .then(data => {
                    ...
                    // replyList 개수만큼 태그를 문자열 형태를 직접 그림.
                    // 중간 중간에 들어가야 할 글쓴이, 날짜, 댓글 내용은 목록에서 꺼내서 표현
            ...
            .replyModify요소는 실제 존재하는 요소가 아니라
            비동기 통신을 통해 생성되는 요소입니다.
            그러다 보니이벤트가 등록되는 시점보다 fetch 함수의 실행이 먼저 끝날 것이라는
           ...
           $replyList.addEventListener('click', (e) => {
                ...
                // 모달 내부에 숨겨진 input태그에 댓글 번호를 달아주자
